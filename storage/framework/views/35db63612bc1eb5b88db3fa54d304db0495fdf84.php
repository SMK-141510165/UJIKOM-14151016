            ...
            <div class="row">
                ...
                <?php if(Auth::guest()): ?>
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills"> <b><?php echo e(Auth::user()->name); ?></b> , Anda Memilih Golongan</span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $gol; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><center><a title="Detail" href="<?php echo e(url('Golongan',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></center></a></th>
                                 <th><center><a title="Edit" href="<?php echo e(route('Golongan.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></center></a></th>
                                 <th><center>
