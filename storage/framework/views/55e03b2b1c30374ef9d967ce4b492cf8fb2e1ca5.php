  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="form-inline">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              <?php echo Form::number('Nip',null,['class'=>'form-control col-md-7 col-xs-12', 'readonly']); ?>&nbsp;&nbsp;
               <a title="Edit NIP" href="<?php echo e(route('Pegawai2.edit',$pegawai->id)); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
          </div>
      </div>
      </div>
     <div class="form-group">
