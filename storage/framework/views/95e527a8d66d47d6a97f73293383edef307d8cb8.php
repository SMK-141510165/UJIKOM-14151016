                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><center><a title="Detail" href="<?php echo e(url('Pegawai',$data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></center></th>
                                 <th><center><a title="Edit" href="<?php echo e(route('Pegawai.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a></center></th>
                                 <th><center>
