                      ...
                      <tbody>
                         ...
                         @foreach ($tunjangan as $data)
                             <tr>
                                 ...
                                 <th><center><a title="Detail" href="{{url('Tunjangan',$data->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a></center></th>
                                 <th><center><a title="Edit" href="{{route('Tunjangan.edit',$data->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a></center></th>
                                 <th><center>
