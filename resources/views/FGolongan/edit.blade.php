 ...
 <div class="right_col" role="main">
    ...
    <div class="form-inline">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              {!! Form::number('Kode_golongan',null,['class'=>'form-control col-md-7 col-xs-12', 'readonly']) !!}&nbsp;&nbsp;
               <a title="Edit Kode Golongan" href="{{route('Golongan2.edit',$data->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
          </div>
      </div>
      </div>
      <div class="form-group">
