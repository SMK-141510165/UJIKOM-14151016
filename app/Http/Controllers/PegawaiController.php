...
class PegawaiController extends Controller
{
    ...
    if ($pegawai->save()) {
            Session::flash('pesan_sukses','Berhasil Menambahkan Data Pegawai');
        }
        else{
            Session::flash('pesan_gagal','Gagal Menambahkan Data Pegawai');
        }
    ...
    public function show($id)
    {
        ...
        $golongan = Golongan::all();
        $jabatan = Jabatan::all();
        return view('FPegawai.show',compact('data','golongan','jabatan'));
    }
    ...
    public function edit( $id)
    {
        ...
        return view('FPegawai.edit',compact('pegawai','golongan','jabatan','jselect','gselect'));
    }
