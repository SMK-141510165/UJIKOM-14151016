...
class LemburController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $kselect = kategori_lembur::whereIn('id',[$data->Kode_lembur_id])->first();
        $kategori = kategori_lembur::whereNotIn('id',[$data->Kode_lembur_id])->get();

        $pselect = Pegawai::whereIn('id',[$data->pegawai_id])->first();
        $pegawai = Pegawai::whereNotIn('id',[$data->pegawai_id])->get();

        return view('FLembur.edit',compact('data','kategori','pegawai','pselect','kselect'));
    }
