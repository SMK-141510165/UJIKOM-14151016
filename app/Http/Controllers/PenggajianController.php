...
class PenggajianController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       elseif (!isset($lembur_pegawai)) {
        ...
        else
        {
            ...
            $gaji->Jumlah_jam_lembur = $lembur_pegawai->Jumlah_jam+=$data->Jumlah_jam;
            $gaji->Jumlah_uang_lembur =($lembur_pegawai->Jumlah_jam+=$data->Jumlah_jam)*($kategori_lembur->Besaran_uang);
            $gaji->Gaji_pokok=$jabatan->Besaran_uang+$golongan->Besaran_uang;
    ...
    public function edit($id)
    {
        ...
        return view('FPenggajian.edit',compact('data','tunjangan','pselect','pegawai'));
    }
